                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                  ...
                  <div class="footer_credit">
                   <div class="footer_sns">
                     ...
                     <!-- <div class="footer_item_spinbarIcon">
                      <a href="http://bar.spincoaster.com/">
                        <img class="spinbarIcon" src="<?php echo get_template_directory_uri(); ?>/assets/images/Spinbar_logo.jpg" alt="spinbar_link">
                      </a>
                     </div> -->
